...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <meta name="description" content="Frontend web-developer from Ashland, KY, specializing in HTML, CSS, JavaScript, WordPress, and learning Ruby on Rails, Backbone, and Angular.">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" href="favicon.ico">
    <script src="//use.typekit.net/mrk0yqw.js"></script>
  ...
  <body>
    ...
    <aside class="side">
      <a href="cory-simmons-resume.pdf" class="resume">
        <img src="img/pdf.svg" alt="Download my PDF Resume" title="PDF Resume">
      </a>
      <img src="img/logo.svg" class="logo">
      <img src="img/cory-simmons.svg" class="cory">
    </aside>

    <section class="content">

      <article class="auto-biography">
        <header>
      ...
      <article class="light-bg experience">

        <header>
          <h1>My past experience says a lot</h1>
        </header>

        <figure>
          <img src="img/launchbox.svg" alt="LaunchBox logo, a box flying upwards">
          <figcaption>
            <header>
              <h3>LaunchBox</h3>
              <h4>UI Designer and Developer</h4>
              <p>
                April 2002 &mdash; Present
              </p>
            </header>
            <p>
              I've been doing freelance work for over a dozen years for a plethora of happy clients.
            </p>
          </figcaption>
        </figure>

        <figure>
          <img src="img/mojotech.jpg" alt="MojoTech logo, an M inside of a hexagon">
          <figcaption>
            <header>
              <h3>MojoTech</h3>
              <h4>Developer</h4>
      ...
      <article class="social">
        ...
        <a href="https://twitter.com/ccccory" target="_blank" title="Twitter">
          <img src="img/twitter.svg" alt="Twitter">
        </a>

        <a href="https://www.facebook.com/cccccory" target="_blank" title="Facebook">
      ...
      <div class="light-bg contact">
        ...
        <form action="send.php" method="POST">
          <label for="f-name">
            <span>Name</span>
            <input id="f-name" name="f-name" type="text" placeholder="First, or last, or both" required>
          </label>
          <label for="f-email">
            <span>E-mail</span>
            <input id="f-email" name="f-email" type="email" placeholder="A valid e-mail address" required>
          </label>
          <label for="f-message">
            <span>Message</span>
            <textarea id="f-message" name="f-message" placeholder="What would you like to say?" required></textarea>
          </label>
          <button type="submit">
            <img src="img/send.svg"> <!-- http://thenounproject.com/term/envelope/13325/ -->
            <span>Send</span>
          </button>
